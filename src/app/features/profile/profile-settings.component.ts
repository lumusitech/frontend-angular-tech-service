        ...
        @if (profileResource.isLoading()) {
          ...
          <div class="bg-gradient-to-r from-blue-600 to-blue-700 px-6 py-8">
            <div class="flex items-center gap-5">
              ...
              >
                <div
                  class="w-20 h-20 rounded-2xl bg-white/20 backdrop-blur-sm flex items-center justify-center text-4xl border-2 border-white/30 group-hover:border-white/60 transition-colors"
                >
                  {{ avatarDisplay() }}
                </div>
                <div
                  class="absolute inset-0 rounded-2xl bg-black/0 group-hover:bg-black/20 transition-colors flex items-center justify-center"
                >
        ...
        <div class="ml-0 sm:ml-13 space-y-4">
          ...
          <div class="flex justify-end">
            <button
              ...
              color="warn"
              [disabled]="
                savingPassword() || !passwordForm.currentPassword() || !passwordForm.newPassword()
              "
