...
describe('UserFormComponent', () => {
  ...
  function setup(data: { mode: 'create' | 'edit'; user?: never }) {
    ...
    TestBed.configureTestingModule({
      ...
      providers: [
        ...
        { provide: UsersService, useValue: { create: createSpy, update: updateSpy } },
  ...
  describe('edit mode', () => {
    ...
    beforeEach(() => setup({ mode: 'edit', user: existing } as never));
