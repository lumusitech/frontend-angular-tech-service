      ...
      <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
        ...
        <div class="space-y-3">
          @for (client of clients(); track client.clientId) {
            <div class="flex items-center justify-between p-3 rounded-lg bg-gray-50 dark:bg-gray-700/50 cursor-pointer hover:opacity-80 transition-opacity" (click)="clientClick.emit({ id: client.clientId, name: client.clientName })">
              <div>
