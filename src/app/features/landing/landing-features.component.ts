          ...
          @for (feature of features; track feature.key) {
            ...
            >
              <div>
                ...
                <div
                  class="w-12 h-12 rounded-xl bg-gradient-to-br from-blue-500/10 to-indigo-500/10 dark:from-blue-500/20 dark:to-indigo-500/20 border border-blue-100 dark:border-blue-800/40 flex items-center justify-center mb-5 text-blue-600 dark:text-blue-400 group-hover:scale-110 group-hover:bg-blue-600 group-hover:text-white transition-all duration-300"
                >
                  <mat-icon class="!w-6 !h-6 !text-2xl">{{ feature.icon }}</mat-icon>
                </div>

                <h3
                  class="text-base sm:text-lg font-bold text-gray-900 dark:text-white mb-2 tracking-tight"
                >
