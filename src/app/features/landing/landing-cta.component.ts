  ...
  template: `
    <section class="py-14 sm:py-20 px-4">
      <div class="max-w-5xl mx-auto">
        <div class="relative bg-gradient-to-br from-blue-900 via-indigo-900 to-gray-950 text-white rounded-3xl p-8 sm:p-12 md:p-16 shadow-2xl overflow-hidden text-center border border-blue-800/40">
