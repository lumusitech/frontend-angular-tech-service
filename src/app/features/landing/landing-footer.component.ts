...
@Component({
  ...
  template: `
    <footer
      class="border-t border-gray-200/80 dark:border-gray-800/80 bg-white dark:bg-gray-950 py-10"
    >
      <div class="max-w-6xl mx-auto px-4">
        <div class="flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <nav
            class="flex flex-wrap items-center justify-center gap-6 text-xs sm:text-sm text-gray-600 dark:text-gray-400"
          >
            <a
              routerLink="/login"
              class="hover:text-blue-600 dark:hover:text-blue-400 transition-colors font-medium"
            >
