    ...
    <section id="how-it-works" class="py-16 md:py-24">
      <div class="max-w-6xl mx-auto px-4">
        ...
        <div class="relative isolate">
          <div class="hidden md:block absolute top-10 left-[calc(12.5%+40px)] w-[calc(25%-80px)] h-[2px] bg-gray-200 dark:bg-gray-700 z-0"></div>
          <div class="hidden md:block absolute top-10 left-[calc(37.5%+40px)] w-[calc(25%-80px)] h-[2px] bg-gray-200 dark:bg-gray-700 z-0"></div>
          <div class="hidden md:block absolute top-10 left-[calc(62.5%+40px)] w-[calc(25%-80px)] h-[2px] bg-gray-200 dark:bg-gray-700 z-0"></div>
          <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-8 relative z-10">
            @for (step of steps; track step.number) {
              <div class="flex flex-col items-center text-center relative">
                <div class="w-20 h-20 rounded-full bg-blue-50 dark:bg-blue-950/30 border-4 border-white dark:border-gray-950 flex items-center justify-center mb-4">
