    ...
    <div class="p-4 space-y-4">
      <div class="flex justify-between items-center">
        ...
        >
          ...
          <span class="text-xs sm:text-sm font-medium">{{ 'workOrders.materials.addMaterial' | translate }}</span>
        </button>
      </div>
      ...
      @if (!materials() || materials().length === 0) {
        ...
        <div class="space-y-3 block sm:hidden">
          @for (material of materials(); track material.id) {
            <div class="p-3.5 bg-gray-50 dark:bg-gray-700/50 rounded-xl border border-gray-200/80 dark:border-gray-700 space-y-2.5 shadow-2xs">
              ...
              <div class="flex items-center justify-between text-xs text-gray-600 dark:text-gray-300 pt-2 border-t border-gray-200/60 dark:border-gray-600/50">
          ...
          <div class="flex justify-between items-center p-3 bg-blue-50/80 dark:bg-blue-950/50 rounded-xl border border-blue-100 dark:border-blue-900/60 font-medium text-sm text-blue-900 dark:text-blue-200 shadow-2xs">
        ...
        <div class="hidden sm:block overflow-hidden rounded-xl border border-gray-200 dark:border-gray-700/80">
          <table class="w-full text-sm">
            <thead>
              <tr class="bg-gray-50 dark:bg-gray-800/80 border-b border-gray-200 dark:border-gray-700">
                ...
                <th class="text-center py-2.5 px-3.5 font-semibold text-gray-600 dark:text-gray-300 w-20">
                  {{ 'common.actions' | translate }}
                </th>
              </tr>
            </thead>
            <tbody class="divide-y divide-gray-200 dark:divide-gray-700/70 bg-white dark:bg-gray-800">
              @for (material of materials(); track material.id) {
                <tr class="hover:bg-gray-50/60 dark:hover:bg-gray-700/40 transition-colors">
                  ...
                  <td class="py-2.5 px-3.5 text-right font-semibold text-gray-900 dark:text-gray-100 font-mono">
                    {{ getItemTotal(material) | currencyArs }}
                  </td>
            ...
            <tfoot>
              <tr class="bg-blue-50/70 dark:bg-blue-950/40 font-semibold text-blue-900 dark:text-blue-200 border-t-2 border-blue-200 dark:border-blue-800">
                <td colspan="4" class="py-2.5 px-3.5 text-right">
                  {{ 'workOrders.materials.totalMaterials' | translate }}:
                </td>
                <td class="py-2.5 px-3.5 text-right text-base font-bold text-blue-700 dark:text-blue-300 font-mono">
                  {{ total() | currencyArs }}
                </td>
                <td></td>
              </tr>
