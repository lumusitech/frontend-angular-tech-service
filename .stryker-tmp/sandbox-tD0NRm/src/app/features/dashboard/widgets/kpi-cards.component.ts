...
export class KpiCardsComponent {
  ...
  primaryColor = input<string>(stryMutAct_9fa48("2188") ? "" : (stryCov_9fa48("2188"), '#1E40AF'));
  secondaryColor = input<string>(stryMutAct_9fa48("2189") ? "" : (stryCov_9fa48("2189"), '#059669'));
  borderColor = input<string>(stryMutAct_9fa48("2190") ? "" : (stryCov_9fa48("2190"), '#1E40AF'));
