...
export interface UpdateWorkOrderDto {
  /** @example "in_progress" */
  status?: "pending" | "assigned" | "in_progress" | "postponed" | "completed" | "delivered" | "cancelled";
...
export interface CreateInvoiceDto {
  ...
  clientIvaCondition?: "responsable_inscripto" | "consumidor_final" | "monotributo" | "exento";
  /** @example 10000 */
  subtotal: number;
  /** @example 2100 */
  ivaAmount?: number;
...
export interface CreateInquiryDto {
  ...
  description: string;
  /** @example "phone" */
  source: "phone" | "whatsapp" | "email" | "walk_in" | "social_media" | "referral";
  /** @example "high" */
  priority?: string;
  /** @example "c3d4e5f6-a7b8-9012-cdef-123456789012" */
  assignedToId?: string;
...
export interface UpdateInquiryDto {
  status?: "new" | "contacted" | "reviewed" | "approved" | "rejected" | "converted";
  ...
  recommendation?: "repair" | "replacement" | "maintenance" | "inspection" | "no_action";
